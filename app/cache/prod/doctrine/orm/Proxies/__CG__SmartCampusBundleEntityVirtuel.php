 ...
 */
class Virtuel extends \Smart\CampusBundle\Entity\Virtuel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Smart\\CampusBundle\\Entity\\Virtuel' . "\0" . 'script');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Virtuel $proxy) {
